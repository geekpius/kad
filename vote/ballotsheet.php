...
<html lang="en">
    ...
    <!-- multistep form -->
        ...
        <!-- <fieldset>
            <h2 class="fs-title text-danger">You are about to preview selected candidates. <br><br> <strong style="font-size:26px">Click on preview to view your choosen candidates</strong></h2>
            <input type="hidden" name="_token" value="">
            <input type="submit" value="PREVIEW SELECTED CANDIDATES" style="width: 100% !important; height: 50px; font-size: 18px" name="submit" id="submit">
        </fieldset> -->
        </form>
